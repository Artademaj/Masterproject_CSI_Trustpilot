...
find_duplicates_final = find_duplicates_final.assign(category='animals_pets')
# Save df into SQL database
final_reviews_animals_pets = find_duplicates_final
final_reviews_animals_pets.to_sql('final_reviews_animals_pets', engine)