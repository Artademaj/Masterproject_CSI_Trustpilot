...
find_duplicates_final = find_duplicates_final.assign(category='public_local_services')
# Save df into SQL database
final_reviews_public_local_services = find_duplicates_final
final_reviews_public_local_services.to_sql('final_reviews_public_local_services', engine)
