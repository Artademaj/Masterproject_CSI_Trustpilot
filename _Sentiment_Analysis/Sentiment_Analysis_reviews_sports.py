...
find_duplicates_final = find_duplicates_final.assign(category='sports')
# Save df into SQL database
final_reviews_sports = find_duplicates_final
final_reviews_sports.to_sql('final_reviews_sports', engine)
