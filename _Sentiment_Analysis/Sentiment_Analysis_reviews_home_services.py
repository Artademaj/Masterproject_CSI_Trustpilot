...
find_duplicates_final = find_duplicates_final.assign(category='home_services')
# Save df into SQL database
final_reviews_home_services = find_duplicates_final
final_reviews_home_services.to_sql('final_reviews_home_services', engine)
