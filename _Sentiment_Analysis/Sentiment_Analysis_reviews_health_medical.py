...
find_duplicates_final = find_duplicates_final.assign(category='health_medical')
# Save df into SQL database
final_reviews_health_medical = find_duplicates_final
final_reviews_health_medical.to_sql('final_reviews_health_medical', engine)
