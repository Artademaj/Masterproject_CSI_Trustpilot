...
find_duplicates_final = find_duplicates_final.assign(category='business_services')
# Save df into SQL database
final_reviews_business_services = find_duplicates_final
final_reviews_business_services.to_sql('final_reviews_business_services', engine)
