...
find_duplicates_final = find_duplicates_final.assign(category='restaurants_bars')
# Save df into SQL database
final_reviews_restaurants_bars = find_duplicates_final
final_reviews_restaurants_bars.to_sql('final_reviews_restaurants_bars', engine)
