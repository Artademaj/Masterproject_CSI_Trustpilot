...
review_data = pd.read_sql_table(
    "reviews_vehicles_transportation",
    con=engine
)
# Change column name
...
find_duplicates_final = find_duplicates_final.assign(category='vehicles_transportation')
# Save df into SQL database
final_reviews_vehicles_transportation = find_duplicates_final
final_reviews_vehicles_transportation.to_sql('final_reviews_vehicles_transportation', engine)
