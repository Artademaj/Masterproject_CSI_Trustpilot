...
review_data = pd.read_sql_table(
    "reviews_electronics_technology",
    con=engine
)
# Change column name
...
find_duplicates_final = find_duplicates_final.assign(category='electronics_technology')
# Save df into SQL database
final_reviews_electronics_technology = find_duplicates_final
final_reviews_electronics_technology.to_sql('final_reviews_electronics_technology', engine)
