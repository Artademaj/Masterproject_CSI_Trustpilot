...
find_duplicates_final = find_duplicates_final.assign(category='events_entertainment')
# Save df into SQL database
final_reviews_events_entertainment = find_duplicates_final
final_reviews_events_entertainment.to_sql('final_reviews_events_entertainment', engine)
