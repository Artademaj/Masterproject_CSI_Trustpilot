...
review_data = pd.read_sql_table(
    "reviews_legal_services_government",
    con=engine
)
# Change column name
...
find_duplicates_final = find_duplicates_final.assign(category='legal_services_government')
# Save df into SQL database
final_reviews_legal_services_government = find_duplicates_final
final_reviews_legal_services_government.to_sql('final_reviews_legal_services_government', engine)