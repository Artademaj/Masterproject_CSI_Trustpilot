...
find_duplicates_final = find_duplicates_final.assign(category='education_training')
# Save df into SQL database
final_reviews_education_training = find_duplicates_final
final_reviews_education_training.to_sql('final_reviews_education_training', engine)
