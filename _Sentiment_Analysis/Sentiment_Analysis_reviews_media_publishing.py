...
find_duplicates_final = find_duplicates_final.assign(category='media_publishing')
# Save df into SQL database
final_reviews_media_publishing = find_duplicates_final
final_reviews_media_publishing.to_sql('final_reviews_media_publishing', engine)