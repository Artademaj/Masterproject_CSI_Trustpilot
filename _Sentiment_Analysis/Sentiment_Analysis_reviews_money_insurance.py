...
find_duplicates_final = find_duplicates_final.assign(category='money_insurance')
# Save df into SQL database
final_reviews_money_insurance = find_duplicates_final
final_reviews_money_insurance.to_sql('final_reviews_money_insurance', engine)