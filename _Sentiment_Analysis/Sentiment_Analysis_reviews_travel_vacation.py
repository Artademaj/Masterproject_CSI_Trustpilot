...
find_duplicates_final = find_duplicates_final.assign(category='travel_vacation')
# Save df into SQL database
final_reviews_travel_vacation = find_duplicates_final
final_reviews_travel_vacation.to_sql('final_reviews_travel_vacation', engine)
