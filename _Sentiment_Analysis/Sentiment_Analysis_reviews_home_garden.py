...
find_duplicates_final = find_duplicates_final.assign(category='home_garden')
# Save df into SQL database
final_reviews_home_garden = find_duplicates_final
final_reviews_home_garden.to_sql('final_reviews_home_garden', engine)