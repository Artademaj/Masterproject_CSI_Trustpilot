...
find_duplicates_final = find_duplicates_final.assign(category='food_beverages_tobacco')
# Save df into SQL database
final_reviews_food_beverages_tobacco = find_duplicates_final
final_reviews_food_beverages_tobacco.to_sql('final_reviews_food_beverages_tobacco', engine)
