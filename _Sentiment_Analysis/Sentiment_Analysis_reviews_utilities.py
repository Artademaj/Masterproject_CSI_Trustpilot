...
find_duplicates_final = find_duplicates_final.assign(category='utilities')
# Save df into SQL database
final_reviews_utilities = find_duplicates_final
final_reviews_utilities.to_sql('final_reviews_utilities', engine)
