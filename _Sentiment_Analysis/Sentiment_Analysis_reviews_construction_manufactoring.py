...
review_data = pd.read_sql_table(
    "reviews_construction_manufactoring",
    con=engine
)
# Change column name
...
find_duplicates_final = find_duplicates_final.assign(category='construction_manufactoring')
# Save df into SQL database
final_reviews_construction_manufactoring = find_duplicates_final
final_reviews_construction_manufactoring.to_sql('final_reviews_construction_manufactoring', engine)