...
find_duplicates_final = find_duplicates_final.assign(category='beauty_wellbeing')
# Save df into SQL database
final_reviews_beauty_wellbeing = find_duplicates_final
final_reviews_beauty_wellbeing.to_sql('final_reviews_beauty_wellbeing', engine)