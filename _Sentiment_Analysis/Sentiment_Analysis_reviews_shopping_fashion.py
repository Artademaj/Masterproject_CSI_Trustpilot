...
find_duplicates_final = find_duplicates_final.assign(category='shopping_fashion')
# Save df into SQL database
final_reviews_shopping_fashion = find_duplicates_final
final_reviews_shopping_fashion.to_sql('final_reviews_shopping_fashion', engine)